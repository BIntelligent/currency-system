    ...
    module.exports.run = async (client, interaction, args) => {
        ...
        if (result.error) {
            ...
            if (result.type === 'negative-money') return interaction.reply("You can't deposite negative money");
            if (result.type === 'low-money') return interaction.reply("You don't have that much money in wallet.");
            if (result.type === 'no-money') return interaction.reply("You don't have any money to deposite");
            if (result.type === 'bank-full') return interaction.reply("Your bank is full. It has reached it's limit.");
        } else {
            ...
            if (result.type === 'success') return interaction.reply(`You have deposited $${result.amount} money to your bank.\nNow you've $${result.rawData.wallet} In your wallet and $${result.rawData.bank} in your bank.`);
        };
    }
